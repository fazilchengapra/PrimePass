...
const SearchDialog = ({
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Content
        className={`bg-white p-6 rounded-lg shadow-xl fixed  top-[40%] lg:top-1/6 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 ${contentClass} ${dialogClass}`}
      >
        ...
        <Flex direction="column" gap="3" className="mb-2">
          <TextField.Root className="w-full" onChange={(e) => setQuery(e.target.value)}>
            <TextField.Slot>
